        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-2">
            <span className="relative flex h-2.5 w-2.5">
              ...
              <span className={`relative inline-flex h-2.5 w-2.5 rounded-full ${isLive ? "bg-emerald-400" : "bg-red-400"}`} />
            </span>
            <span className="text-sm font-medium" style={{ color: "var(--text-secondary)" }}>
              {isLive ? "Live" : "Offline"}
            </span>
          ...
          {/* Last updated */}
          {lastUpdated && (
            <div className="hidden text-xs md:block" style={{ color: "var(--text-faint)" }}>
